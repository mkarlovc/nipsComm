...
\begin{figure}\label{evolution}
   	...
   	\end{center}
   	\caption{A section of community evoulution visualization of a collaboration network of a researcher chemistry field of research}
\end{figure}
...
mean \emph{gmean}. \textbf{Regression:} We evaluated the following regression
...
This paper gives a complete approach for detecting, visualizing and modelling evolution of communities...
